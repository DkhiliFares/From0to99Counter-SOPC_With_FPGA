...
module Processeur2_addr_router_001_default_decode
  #(
...
module Processeur2_addr_router_001
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    localparam PAD6 = log2ceil(64'h9050 - 64'h9048); 
    // -------------------------------------------------------
    ...
    Processeur2_addr_router_001_default_decode the_default_decode(
    ...
    // ( 0x9048 .. 0x9050 )
    if ( {address[RG:PAD6],{PAD6{1'b0}}} == 16'h9048   ) begin
